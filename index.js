...
function printStrings(array) {
  ...
  console.log(array.toString().repeat(3));
}
...
function concatenateStrings(array, subString) {
  ...
  let result = arrayString.includes(subString);
  console.log(result);
}
...
function addTenToEach(array) {
  ...
  for (let index in array) {
    // Add 10 to the current element and add the result to the new array
